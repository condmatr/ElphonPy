...
def epw_wdata(param_dict_epw, wannier_plot, kpath_dict):
    ...
    Args:
        param_dict_epw (dict): A dict containing sections for SCF calculation input file ('inputepw', 'wannier_data'  'kq_grid').
...
def epw_input_gen(prefix, structure, pseudo_dict, param_dict_scf, param_dict_nscf, param_dict_epw, kpath_dict, wannier_plot=True, copy_pseudo=False, multE=1.0, workdir='./epw'):
